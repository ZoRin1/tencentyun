    ...
    <div class="container" style="padding: 20px 0px 20px 0px;width: 1200px;">
        ...
        <div class="container-fluid">
            <div class="left col-sm-7 col-xs-7 container" style="height: 600px;padding: 10px 0 50px 0">
                {!! Form::open(['url'=>'auth/login','class'=>'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('','登录',['class'=>'col-sm-12 col-xs-12','style'=>'font-size: 22px']) !!}
                    </div>
                    <div class="form-group" style="margin-top: 30px">
                        {!! Form::label('email','邮箱',['class'=>'col-sm-2 col-sm-offset-1 control-label']) !!}
                        <div class="col-sm-5" style="margin-right: 150px">
                            {!! Form::email('email',null,['class'=>'form-control','placeholder'=>'邮箱']) !!}
                        </div>
                    </div>
                    <div class="form-group" style="margin-top: 30px">
                        {!! Form::label('password','密码',['class'=>'col-sm-2 col-sm-offset-1 control-label']) !!}
                        <div class="col-sm-5" style="margin-right: 150px">
                    ...
                    <div class="form-group" style="margin-top: 30px">
                        <div class="col-sm-offset-3 col-sm-10 ">
                            {!! Form::submit('登录',['class'=>'btn btn-primary','style'=>'width:268px;']) !!}
                        </div>
                    </div>
                {!! Form::close() !!}
            ...
            <div class="right col-sm-5 col-xs-5 container" style="height: 600px;border-left: 1px solid #A3B27A;padding: 50px 0 50px 0;">
                    <div class="col-sm-offset-1 col-sm-8 col-xs-8 col-xs-offset-1" style="font-size: 14px;color: white">
                        还没有注册帐号?<a href="{{ url('auth/register') }}">[立即注册]</a>
                    </div>
            </div>
        </div>
